...
h5_file_path = "EVK_4_DATASET_EVENT_CUBE_RNN/train/center_bottle_mid_1.h5"  # Replace with your file path
channel_to_plot = 8  # Replace with your desired channel index (0 to 124)
